const Footer = () => {
	return (
		<div className="snap-center border-t border-black">
			<footer className="footer p-10 text-base-content">
				<div>
					...
					<a className="link link-hover">MERN App</a>
					<a className="link link-hover">Wordpress</a>
				</div>
				<div>
					<span className="footer-title">More Services</span>
					<a className="link link-hover">Code Debugging</a>
					<a className="link link-hover">Theme Development</a>
